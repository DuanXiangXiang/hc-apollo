...
public class AppController {
  ...
  public PageDTO<App> searchByAppIdOrAppName(@RequestParam(value = "username") String username,@RequestParam(value = "query", required = false) String query,
      Pageable pageable) {
    if (StringUtils.isEmpty(query)) {
      return appService.findAll(username,pageable);
    }
    return appService.searchByAppIdOrAppName(username, query, pageable);
  }
//根据部门和应用id查询app列表
  @GetMapping("/by-owner")
  public List<App> findAppsByOwner(@RequestParam("owner") String owner,@RequestParam("org") String orgId, Pageable page) {
    ...
    return appService.findByOrgIdAndAppIds(orgId,appIds, page);
  }
